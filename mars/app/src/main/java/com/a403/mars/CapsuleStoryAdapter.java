...
public class CapsuleStoryAdapter extends RecyclerView.Adapter<CapsuleStoryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_test, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CapsuleStory capsule = new CapsuleStory(title, created_date, open_date, address, capsule_friends, gps_x, gps_y);
